...
type TopUserPropsType = ITopUser & {position: number, isAuthUser: boolean, viewProfile: (id: number) => void};

export const TopUser: React.FC<TopUserPropsType> = ({position, id, username, rating, isAuthUser, viewProfile}) => {
